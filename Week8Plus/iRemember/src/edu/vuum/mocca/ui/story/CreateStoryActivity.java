...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		String soundFile = getOutputMediaFile(MEDIA_TYPE_AUDIO).getPath();

		// DONE - Add the filename to the Intent as an extra. Use the
		// Intent-extra name
		// from the SoundRecordActivity class, EXTRA_OUTPUT
		soundIntent.putExtra(SoundRecordActivity.EXTRA_OUTPUT, soundFile);

		// DONE - Start a new activity for result, using the new intent and the
		// request
	...
	private void launchCameraIntent() {
		...
		// DONE - Create a new intent to launch the MediaStore, Image capture
		// function
		...
		// DONE - Set the imagePath for this image file using the pre-made
		// function
	...
	private void launchVideoCameraIntent() {
		...
		// DONE - Set the fileUri for this video file using the pre-made
		// function
		// getOutputMediaFile to create a new filename for this specific video;
		String videoFile = getOutputMediaFile(MEDIA_TYPE_VIDEO).getPath();
		...
		// DONE - Specify as an extra that the video quality should be HIGH. Use
		// the
